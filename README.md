# @mattuk94/css-modules-snapshots
...
```bash
npm install --save-dev @mattuk94/css-modules-snapshots
```
...
module.exports = {
  transform: {
    '\\.(css|scss)$': '@mattuk94/css-modules-snapshots/transformer',
  },
};
```
...
**jest.setup.js:**
```javascript
import '@mattuk94/css-module-snapshots';
```
